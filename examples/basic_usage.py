...
async def main():
    ...
    await plugin_manager.handle_claude_code_event('file_modified', {
    ...
    await plugin_manager.handle_claude_code_event('command_executed', {
        'command': 'Edit',
        'success': True
    })
    
    # Simulate token usage update
    await plugin_manager.handle_claude_code_event('token_usage_updated', {
        'token_count': 45000,
        'token_limit': 200000
    })

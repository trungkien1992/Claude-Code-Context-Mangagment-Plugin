...
class RealTimeMonitor:
    ...
    def _calculate_current_burn_rate(self) -> float:
        ...
        token_diff = recent_metrics[-1].current_tokens - recent_metrics[0].current_tokens
        
        if time_diff > 0:
            return token_diff / time_diff
        return 0.0
    
    def _calculate_time_to_limit(self, current_tokens: float, burn_rate: float) -> Optional[float]:
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        if len(self.metrics_history) >= 2:
            ...
            trends = {
                ...
                'response_time': latest_metrics.avg_response_time - prev_metrics.avg_response_time,
                'confidence': latest_metrics.confidence_score - prev_metrics.confidence_score,

...
class SessionState:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'SessionState':
        ...
        data['recovery_points'] = [datetime.fromisoformat(rp) for rp in data['recovery_points']]
        return cls(**data)
...
class SessionPersistenceManager:
    ...
    async def recover_session(self, session_id: str, recovery_point: datetime = None) -> Optional[SessionState]:
        ...
        try:
            ...
            if recovery_point is None:
                ...
                if not session_state.recovery_points:
                    logger.warning(f"No recovery points found for session: {session_id}")
                    return session_state
            ...
            if checkpoint_key in session_state.checkpoint_data:
                ...
                logger.warning(f"Checkpoint not found for recovery point: {recovery_point}")
                return session_state
    ...
    async def _update_session_metadata(self, session_state: SessionState, file_path: Path):
    ...
    async def get_session_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Sessions by type
            cursor.execute("SELECT session_type, COUNT(*) FROM sessions GROUP BY session_type")

...
class BenchmarkSuite:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        throughputs = [r.operations_per_second for r in self.results if r.operations_per_second > 0]
...
class PerformanceBenchmarker:
    ...
    async def run_latency_benchmark(self, 
                                   ...
                                   operation: Callable,
                                   iterations: int = None,
                                   warmup: int = None) -> BenchmarkResult:
        ...
        try:
            ...
            logger.info(f"✅ Latency benchmark completed: {name} - {result.latency_mean:.4f}s avg")
    ...
    async def run_throughput_benchmark(self, 
                                      name: str, 
                                      operation: Callable,
                                      duration_seconds: float = 10.0) -> BenchmarkResult:
        ...
        try:
            ...
            logger.info(f"✅ Throughput benchmark completed: {name} - {result.operations_per_second:.2f} ops/sec")
    ...
    async def run_memory_benchmark(self, 
        ...
        try:
            ...
            logger.info(f"✅ Memory benchmark completed: {name} - {result.memory_usage:.2f}MB peak")
    ...
    async def run_concurrency_benchmark(self, 
                                       name: str, 
                                       operation: Callable,
                                       concurrency_levels: List[int] = None) -> BenchmarkResult:
    ...
    async def run_benchmark_suite(self, 
                                 benchmarks: List[Tuple[str, Callable, Dict[str, Any]]]) -> BenchmarkSuite:
        ...
        logger.info(f"🏁 Benchmark suite completed: {summary['passed']}/{summary['total']} passed")
        
        return suite
    
    def export_results(self, suite: BenchmarkSuite, filename: str, format: str = 'json'):
...
async def benchmark_context_analysis():
    ...
    from claude_context_management.core.analysis import ContextAnalysisEngine
...
async def benchmark_confidence_scoring():
    ...
    from claude_context_management.core.analysis import calculate_analysis_confidence
...
async def benchmark_performance_metrics():
    ...
    from claude_context_management.core.analysis import metrics_engine, MetricType
...
async def run_full_benchmark_suite() -> BenchmarkSuite:
    ...
    benchmarks = [
        ("context_analysis", benchmark_context_analysis, {'type': 'latency', 'iterations': 50}),
        ("confidence_scoring", benchmark_confidence_scoring, {'type': 'latency', 'iterations': 100}),
        ("performance_metrics", benchmark_performance_metrics, {'type': 'throughput', 'duration': 5.0}),
        ("context_analysis_memory", benchmark_context_analysis, {'type': 'memory', 'iterations': 20}),
        ("confidence_scoring_concurrency", benchmark_confidence_scoring, {'type': 'concurrency', 'concurrency_levels': [1, 2, 4, 8]})
    ]

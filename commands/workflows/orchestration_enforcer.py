...
class OrchestrationEnforcer:
    ...
    def check_orchestration_compliance(self):
        ...
        if time_since_last > timedelta(minutes=30):
            return True, f"Last orchestration was {time_since_last.total_seconds()/60:.1f} minutes ago"
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("Example: python orchestration_enforcer.py 'Starting Phase 2 implementation'")
